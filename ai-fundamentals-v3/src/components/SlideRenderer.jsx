...
function getVideoUrl(url, theme) {
  try {
...
function VideoSlide({ slide, theme }) {
  const videoUrl = getVideoUrl(slide.embedUrl, theme);
...
export default function SlideRenderer({ slide, printVariant, theme = "dark" }) {
  let content = null;

  switch (slide.type) {
    case "title":
      content = <TitleSlide slide={slide} />;
      break;
    case "image":
      content = <ImageSlide slide={slide} />;
      break;
    case "statement":
      content = <StatementSlide slide={slide} />;
      break;
    case "visual-statement":
      content = <VisualStatementSlide slide={slide} />;
      break;
    case "infographic":
      content = <InfographicSlide slide={slide} />;
      break;
    case "roles-contrast":
      content = <RolesContrastSlide slide={slide} />;
      break;
    case "audience-poll":
      content = <AudiencePollSlide slide={slide} />;
      break;
    case "video":
      content = <VideoSlide slide={slide} theme={theme} />;
      break;
    case "product-showcase":
      content = <ProductShowcaseSlide slide={slide} />;
      break;
    case "cards":
      content = <CardsSlide slide={slide} />;
      break;
    case "manifesto":
      content = <ManifestoSlide slide={slide} />;
      break;
    case "evidence":
      content = <EvidenceSlide slide={slide} />;
      break;
    case "call-to-action":
      content = <CallToActionSlide slide={slide} />;
      break;
    case "agenda":
      content = <AgendaSlide slide={slide} />;
      break;
    case "comparison":
      content = <ComparisonSlide slide={slide} />;
      break;
    case "context-flow":
      content = <ContextFlowSlide slide={slide} />;
      break;
    case "code-columns":
      content = <CodeColumnsSlide slide={slide} />;
      break;
    case "context-action":
      content = <ContextActionSlide slide={slide} />;
      break;
    case "centered":
      content = <CenteredSlide slide={slide} />;
      break;
    case "tips":
      content = <TipsSlide slide={slide} activeIndex={printVariant?.activeTipIndex} />;
      break;
    case "setup":
      content = <SetupSlide slide={slide} activeStep={printVariant?.activeStepIndex} />;
      break;
    case "table":
      content = <TableSlide slide={slide} />;
      break;
    case "homework":
      content = <HomeworkSlide slide={slide} />;
      break;
    case "end":
      content = <EndSlide slide={slide} />;
      break;
    default:
      content = null;
  }
  ...
  return (
    <div className="slide-renderer" data-theme={theme}>
      {content}
    </div>
  );
}
